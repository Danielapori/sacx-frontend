    ...
    <div id="faq" className="block faqBlock">
      <div className="container-fluid">
        <div className="titleHolder">
          ...
          <p>These are questions that our customers ask and could be of help to you!</p>
        </div>
        ...
        <div className="quickSupport">
          ...
          <p>Having issues and need help contact us on our emergency email, and we would get back to you as soon as possible. NB that this email is for emergencies only, thank you for cooperation</p>
